...
export default function ShopPage() {
    ...
    const [whatsappUrl, setWhatsappUrl] = useState('https://chat.whatsapp.com/ElBYUnPmbqt86voJGQs9tZ');
    ...
    const loadWhatsappUrl = async () => {
        try {
            const response = await fetch('/api/settings/whatsapp-url');
            if (response.ok) {
                const data = await response.json();
                if (data.url) {
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 flex-1">
                            ...
                            <a 
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 text-sm font-medium border border-green-400/30 hover:scale-105"
                            >
                                ...
                                <span>לעדכונים על איסוף ההזמנה</span>
                            </a>
                        </div>
