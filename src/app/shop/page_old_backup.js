                ...
                <div className="fixed bottom-8 right-8 z-50 animate-slide-up">
                    ...
                    >
                        ...
                        <div className="cart-total-preview">
                            ...
                            <span className="text-gradient font-bold">₪{calculateCartTotal()}</span>
                        </div>
                    </button>
                </div>
            )}
            ...
            <aside className="fixed right-0 top-0 h-full w-20 z-40 glass-sidebar">
                <div className="flex flex-col items-center py-6 gap-6">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        {user?.role === 'admin' && (
                            <Link href="/admin" className="sidebar-nav-item admin-glow" title="פאנל ניהול">
                                <span className="text-2xl">⚡</span>
                            </Link>
                        )}
                        <button 
                ...
                <div className="top-status-bar glass-card">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-lg font-bold text-gradient">שלום, {user?.full_name}</h2>
                                <p className="text-sm" style={{color: 'var(--text-secondary)'}}>ברוך הבא חזרה!</p>
                            </div>
                        </div>
                            ...
                            <div className={`status-badge-modern ${shopStatus}`}>
                                {shopStatus === 'open' ? (
                                    <>
                                        ...
                                        <span>החנות פתוחה</span>
                                    </>
                                ) : shopStatus === 'closed' ? (
                                    <>
                                        <span className="status-dot"></span>
                                        <span>החנות סגורה</span>
                                    </>
                                ) : (
                                    <>
